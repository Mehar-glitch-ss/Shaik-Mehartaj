...
1. Problem-1: Simple calculator using class and operations like addition, subtraction, multiplication, and division.
...
2. Problem-2: Print the first `a` odd numbers based on input.
...
3. Problem-3: If input is even, print `a-1` odd numbers; if odd, print `a` odd numbers.
 With a single integer as the input, generate the following until a = x [series of numbers as shown in below examples]
...
4. Problem-4: Count how many numbers in a given list are divisible by numbers 1 to 9.
